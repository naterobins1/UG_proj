...
myfile = ImaFile(simulations_folder='/home/nathanrobins/UG_proj/simdata.1', nr_samples=128, model_name='Marth-3epoch-CEU')
...
while i < 5:
    ...
    myfile = ImaFile(simulations_folder='/home/nathanrobins/UG_proj/simdata.' + str(i), nr_samples=128, model_name='Marth-3epoch-CEU')
    mygene = myfile.read_simulations(parameter_name='selection_coeff_hetero', max_nrepl=2000)
